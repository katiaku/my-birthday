        ...
        <div class="col-md-6">
            <div class="card mb-5 shadow">
                <div class="card-header bg-success py-3">
                    <h5 class="card-title text-white text-center fs-3 fw-semibold">Edit Birthday Item</h5>
                </div>
                <div class="card-body border rounded-bottom border-2 border-success">
                    ...
                    <fieldset class="mt-3 mb-2 text-secondary">
                        ...
                        <div class="form-group">
                            <?php echo $this->Form->control('units', ['class' => 'form-control fs-4']); ?>
                        </div>
                        <div class="form-group">
                    ...
                    <?= $this->Form->postLink(
                        ...
                        ['confirm' => __('Are you sure you want to delete # {0}?', $birthdayItem->id), 'class' => 'btn btn-danger btn-lg w-100 mt-4 fw-semibold fs-4 text-white text-uppercase']
                    ) ?>
                    <?= $this->Form->end() ?>
                </div>
            </div>
